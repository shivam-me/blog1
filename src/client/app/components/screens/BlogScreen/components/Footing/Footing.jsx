...
const Footing = () => (
  <div className={styles.footing}>
    <div className={styles.inner}>
      <nav>
        <ul>
          {/* <li><a target="_blank" rel="noopener noreferrer" href="https://google.com">About kentcdodds</a></li>
          <li><a target="_blank" rel="noopener noreferrer" href="https://google.com">Latest Stories</a></li>
          <li><a target="_blank" rel="noopener noreferrer" href="https://google.com">Archive</a></li>
