  ...
  <div className={styles['pre-content']}>
    <div className={withoutBottomLine ? `${styles.inner} ${styles['inner--without-bottom-line']}` : styles.inner}>
      <div className={styles.links}>
        ...
        {/* <a href="https://google.com" target="_blank" rel="noopener noreferrer">FIND KENT AROUND THE WEB</a> */}
      </div>
      <div className={styles.actions}>
        <a className={styles.search} href="#">search</a>
        <a className={`link-icon ${styles.twitter}`} href="https://twitter.com/ShivamS77922097" target="_blank" rel="noopener noreferrer">
